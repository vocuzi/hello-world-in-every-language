...
class CordovaCommand extends command_1.Command {
    ...
    async preRunChecks(runinfo) {
        const { SUPPORTED_PROJECT_TYPES } = await Promise.resolve().then(() => require('../../lib/integrations/cordova'));
        ...
        if (!SUPPORTED_PROJECT_TYPES.includes(this.project.type)) {
            throw new errors_1.FatalException(`Cordova is not supported for ${this.project.type} projects`);
        }
