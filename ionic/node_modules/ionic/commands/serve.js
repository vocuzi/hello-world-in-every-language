...
By default, ${color_1.input('ionic serve')} boots up a development server on all network interfaces and prints the external address(es) on which your app is being served. It also broadcasts your app to the Ionic DevApp on your network. To disable the DevApp and bind to ${color_1.input('localhost')}, use ${color_1.input('--local')}.
