...
export declare class ConfigConfig {
    ...
    readonly pkg: CordovaPackageJson;
    readonly sessionid: string;
    static load(configXmlPath: string, packageJsonPath: string): Promise<ConfigConfig>;
...
export declare function loadCordovaConfig(integration: Required<ProjectIntegration>): Promise<ConfigConfig>;
