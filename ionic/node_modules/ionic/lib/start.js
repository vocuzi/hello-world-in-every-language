...
function getStudioAdvertisement() {
    return `
  ──────────────────────────────────────────────────────────────────

     ${color_1.title('Ionic Studio')}, a powerful, local editor made with ${emoji_1.emoji('💖', 'love')} by Ionic

                  Lightning fast app creation ${emoji_1.emoji('⚡️', '')}
         Quickest & easiest way to get started with Ionic ${emoji_1.emoji('🚀', '')}

        ${emoji_1.emoji('         👉 ', 'Learn more:')} ${color_1.strong('https://ion.link/studio')} ${emoji_1.emoji(' 👈', '')}
...
function getEnterpriseAdvertisement() {
  ...
  ──────────────────────────────────────────────────────────────────────
      ...
      ${color_1.title('Ionic Enterprise')}, platform and solutions for teams by Ionic
       ...
       Bring your company's designs to life with Design Systems ${emoji_1.emoji('🎨', '')}
