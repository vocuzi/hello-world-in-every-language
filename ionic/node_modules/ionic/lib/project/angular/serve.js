...
The dev server can use HTTPS via the ${color_1.input('--ssl')} option ${chalk_1.default.bold.red('(experimental)')}. There are several known issues with HTTPS. See issue #3305[^issue-3305].
`,
            footnotes: [
                {
                    id: 'ng-serve-docs',
    ...
    createOptionsFromCommandLine(inputs, options) {
        ...
        let consolelogsPort = consolelogs ? string_1.str2num(options['consolelogs-port'], serve_1.DEFAULT_DEV_LOGGER_PORT) : undefined;
        // if not defined, default to true for devapp
        if (options.devapp) {
            consolelogs = consolelogs === undefined ? true : consolelogs;
            consolelogsPort = string_1.str2num(options['consolelogs-port'], serve_1.DEFAULT_DEV_LOGGER_PORT);
        }
        return {
            ...baseOptions,
            consolelogs,
